...
class MetadataInsertion extends javax.swing.JFrame {
    static String[] dates=new String[5];
    Base context;
    public MetadataInsertion(Base c) {
        try {
            ...
            java.util.logging.Logger.getLogger(MetadataInsertion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        context=c;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        insertCurrent.setText("Insert Current Metadata");
        ...
        insertPrevious1.setText("Insert Previous Metadata 1");
        ...
        insertPrevious2.setText("Insert Previous Metadata 2");
        ...
        insertPrevious3.setText("Insert Previous Metadata 3");
        ...
        insertPrevious4.setText("Insert Previous Metadata 4");
    ...
    private void insertCurrentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertCurrentActionPerformed
        MetadataInsertion obj=this;
        java.awt.EventQueue.invokeLater(() -> {
            obj.setVisible(false);
            new InputMetadata(obj, 0).setVisible(true);
        });
    ...
    private void insertPrevious1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertPrevious1ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(() -> {
            obj.setVisible(false);
            new InputMetadata(obj, 1).setVisible(true);
        });
    ...
    private void insertPrevious2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertPrevious2ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(() -> {
            obj.setVisible(false);
            new InputMetadata(obj, 2).setVisible(true);
        });
    ...
    private void insertPrevious3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertPrevious3ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(() -> {
            obj.setVisible(false);
            new InputMetadata(obj, 3).setVisible(true);
        });
    ...
    private void insertPrevious4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertPrevious4ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(() -> {
            obj.setVisible(false);
            new InputMetadata(obj, 4).setVisible(true);
        });
